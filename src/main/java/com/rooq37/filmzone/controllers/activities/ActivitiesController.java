package com.rooq37.filmzone.controllers.activities;
...
public class ActivitiesController {
    ...
    public String displayActivities(Principal principal,
        ...
        model.addAttribute("activitiesDTO", activityService.getActivities(principal.getName(), Integer.valueOf(year)));
